...
<div class="container border border-secondary principal mt-3 pt-3">
    <h3 class="text-center">Crear Polilinea</h3>
...
<input type="number" class="form-control" id="latitud3" name="latitud3" min="-90" max="90" value="39.29" step='0.01' required>
<div class="invalid-feedback">
    Ingrese valor min:-90 y max:90
</div>
<div class="valid-feedback">
...
<input type="number" class="form-control" id="longitud3" name="longitud3" min="-180" max="180" step='0.01' value="-5.85" required>
<div class="invalid-feedback">
    Ingrese valor min:-180 y max:180
</div>
<div class="valid-feedback">
