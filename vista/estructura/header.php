      ...
      <ul class="nav nav-tabs navbar-light bg-light">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="ingCoord.php">Cambiar formato</a>
              </li>
              <li>
                <a class="dropdown-item" href="cuaCoord.php">Mostrar 4 coordenadas</a>
              </li>
              <li>
                <a class="dropdown-item" href="longitudLinea.php">Longitud de linea</a>
              </li>
              <li>
                <a class="dropdown-item" href="perimetro.php">Perimetro</a>
              </li>
              <li>
                <a class="dropdown-item" href="crearPolilinea.php">Crear polilinea</a>
              </li>
            </ul>
          </li>
          <!--<li class="nav-item">
